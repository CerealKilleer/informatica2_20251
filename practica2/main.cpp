...
void procesar_numeros(char *, uint, uint, uint);
bool gestionar_asiento(bool asientos[15][20], bool, uint, uint);
bool str_copy(char *, char *);
uint str_to_num(char *str);
uint str_len(char *);
uint sumar_numeros(char *, uint);
uint str_to_num(char *);
